                ...
                && exception.Message.Contains(sessionExpiredKey))
            {
                ...
                try
                {
                        ...
                        )
                    {
                        ...
                        ExtendedMessageBoxExceptionHandler _messageHandler = new ExtendedMessageBoxExceptionHandler("Error", typeof(Cedar.ExceptionHandling.TextExceptionFormatter), "{message}", true);
