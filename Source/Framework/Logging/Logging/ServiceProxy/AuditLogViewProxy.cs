...
namespace HiiP.Framework.Logging.ServiceProxy
{
    public class AuditLogViewProxy : ServiceProxyBase<IAuditLogViewService>, IAuditLogViewService
    {
        ...
        public AuditLogViewDataSet GetAuditDataSummary(Cedar.AuditTrail.AuditTrailSearchCriteria criteria)
        {
            return Proxy.GetAuditDataSummary(criteria);
        }

        //public System.Data.DataSet GetAuditActionSummary(Cedar.AuditTrail.AuditTrailSearchCriteria criteria)
        //{
