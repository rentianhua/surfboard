...
namespace HiiP.Framework.Settings.Interface.Constants
{
    ...
    /// </summary>
    public sealed class EventTopicNames : HiiP.Infrastructure.Interface.Constants.EventTopicNames
    {
        private EventTopicNames()
        {}
        public const string AddInstrumentationFilter = "AddInstrumentationFilter";
        public const string MessageSaveEvent = "MessageSaveEvent";
        public const string ClosedDetail = "ClosedDetail";
    }
}
