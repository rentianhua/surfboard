    ...
    public class AuditLogEntry
    {
            ...
            string appVersion = null, DateTime? logTime = null)
        {
            ...
            this.TransactionId = (string.IsNullOrEmpty(transactionId)
                ...
                : transactionId);
            this.UserId = (string.IsNullOrEmpty(userid) ? ApplicationContext.Current.UserId : userid);
            this.AppVersion = (string.IsNullOrEmpty(appVersion) ? this.GetProjectAssemblyVersion() : appVersion);
            this.Items = new Collection<AuditLogEntryItem>();
            this.LogTime = (logTime.HasValue ? logTime.Value : TimeConverter.CurrentDateTime);
        }
        ...
        protected virtual string GetProjectAssemblyVersion()
        {
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                AssemblyName name = stackFrame.GetMethod().Module.Assembly.GetName();
