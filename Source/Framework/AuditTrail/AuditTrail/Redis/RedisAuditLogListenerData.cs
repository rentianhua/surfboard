...
namespace Cedar.Framwork.AuditTrail.Redis
{
    ...
    /// 
    /// </summary>
    public class RedisAuditLogListenerData : AuditLogListenerDataBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return () => new RedisAuditLogListener(base.Name, base.Filter, new RedisDatabaseWrapper(Server, Database, Password, Port), this.ApplicationName);
        }
    }
}
