...
namespace Cedar.Core.Data
{
    ...
    public abstract class Database
    {
        ...
        /// <returns></returns>
        public abstract int Execute(string sql, dynamic param = null, DbTransaction transaction = null, CommandType commandType = CommandType.Text);
        ...
        /// <param name="commandType"></param>
        /// <returns></returns>
        public abstract IEnumerable<dynamic> Query(string sql, dynamic param = null, CommandType commandType = CommandType.Text);
